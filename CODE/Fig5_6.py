...
ax0.scatter(c_sweep_1,avg_pi,label='Avg. $\pi$',color='#005745',s=12,alpha=1);
ax0.scatter(c_sweep_1,avg_util_high,label='Avg. U; (l = .1)',color='#009175',s=12,alpha=1);
ax0.scatter(c_sweep_1,avg_util_mid,label='Avg. U; (l = .01)',color='#00cba7',s=12,alpha=1);
ax0.scatter(c_sweep_1,avg_util_low,label='Avg. U; (l =.001)',color='#86ffde',s=12,alpha=1);
...
bx.scatter(c_sweep_2,avg_pi_a,label='Avg. $\pi$; Case 1',s=12,marker='o',c = '#005745',alpha=1);
bx.scatter(c_sweep_2,avg_pi_tr,label='Avg. $\pi$; Case 2',s=12,marker='o',c='#8400cd',alpha=1);
bx.scatter(c_sweep_2,avg_util_a,label='Avg. U; Case 1',s=12,marker='o',c = '#00cba7',alpha=1);
bx.scatter(c_sweep_2,avg_util_tr,label='Avg. U; Case 2',s=12,marker='o', c = '#ff92fd',alpha=1);
...
if save == True:
    fig0.savefig("../FIGS/utility1.pdf",bbox_inches='tight', dpi=150)
    fig0.savefig("../FIGS/utility1.png",bbox_inches='tight', dpi=150)
    fig1.savefig("../FIGS/util_tr1.pdf", bbox_inches='tight',dpi=150)
